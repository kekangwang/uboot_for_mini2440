...
#include <config.h>
#include <common.h>
//#include <mmc.h>                      //change by myself:kkw
//#include <asm/arch/mmc.h>             //change by myself:kkw
#include <asm-arm/arch-s3c24x0/mmc.h>   //add by myself: kkw
#include <asm/errno.h>
#include <asm/io.h>
#include <s3c2410.h>
#include <part.h>
...
int mmc_init(int verbose)
{
	...
	*/
	...
	if (verbose)
	print_sd_cid(cid);
	sprintf((char *) mmc_dev.vendor, "Man %02x OEM %c%c \"%c%c%c%c%c\"", cid-
